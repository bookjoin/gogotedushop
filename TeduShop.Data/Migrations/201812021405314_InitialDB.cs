    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Oders", t => t.OrderID, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Warranty = c.Int(),
                        Desicripton = c.String(maxLength: 500),
                        Context = c.String(),
                        HomeFlag = c.Boolean(),
                        HotFlag = c.Boolean(),
                        ViewCount = c.Int(),
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 256),
                        Desscription = c.String(maxLength: 256),
                        Image = c.String(maxLength: 256),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderDetails", "OrderID", "dbo.Oders");
